...
const CRATES = [
  ...
  },
  {
    ...
    cost: 280,
    items: [
      { name: 'Spacesuit', value: 1509, chance: 500 },
      { name: 'Space Rocket Work Gloves', value: 1164, chance: 250 },
      { name: 'Space Raider Rocket Launcher', value: 347, chance: 1400 },
      { name: 'Cobalt Space Door', value: 301, chance: 900 },
      { name: 'Space Raider Pants', value: 182, chance: 1750 },
      { name: 'Space Raider Hoodie', value: 181, chance: 2200 },
      { name: 'Grey Cap', value: 9, chance: 3000 },
    ],
  },
];
